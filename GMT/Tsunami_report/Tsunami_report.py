...
{"Flagname": "Style",              "variable": "style",                    "Flag1": "-style",        "Flag2": "--style",                   "default": "2",              "help": "Choose pre-built styles",                                                      "category": "General",       "data_type": "Number", "group": [{1: "DEM"}, {2: "Gray"}, {3: "Water DEM gray"}, {4: "Water DEM darkblue"}, {5: "DEM gray"}], "user": True},
