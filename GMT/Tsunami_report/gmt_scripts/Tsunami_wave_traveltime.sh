...
gmt grdcontour ${wave_time_temp} -R -J -Wa0.02c,${Isochrone_color} -Wc0.01c,${Isochrone_color},- -Z0.01666666666666666666666666666667 -C0.5 -A1+u' hr'+f8p,Helvetica-Bold,${Isochrone_color} -P -Ya${y_map_dist} -O -K -V >> ${output}
