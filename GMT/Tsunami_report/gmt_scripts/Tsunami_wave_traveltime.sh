...
gmt grdcontour ${wave_time_temp} -R -J -W0.01c,${Isochrone_color} -Z0.01666666666666666666666666666667 -A1+u' hour'+f8p,Helvetica-Bold,${Isochrone_color} -P -Ya${y_map_dist} -O -K -V >> ${output}
