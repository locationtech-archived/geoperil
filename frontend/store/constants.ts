...
export const DATASRV_BASE_URL = process.env.datasrvUrl +
  (process.env.datasrvUrl!.endsWith('/') ? '' : '/')
...
export const API_GET_TFPS_URL = WEBGUISRV_BASE_URL + 'gettfps'
...
export const API_USERLIST_URL = WEBGUISRV_BASE_URL + 'userlist'
export const API_CHANGEUSER_URL = WEBGUISRV_BASE_URL + 'changeuser'
export const API_REGISTERUSER_URL = WEBGUISRV_BASE_URL + 'register'
export const API_INSTLIST_URL = WEBGUISRV_BASE_URL + 'instlist'
export const API_GET_SUPPORTED_PERMISSIONS_URL = WEBGUISRV_BASE_URL +
...
export const API_GET_AVAILABLE_PRODUCTS = DATASRV_BASE_URL + 'help'
export const API_GET_GMT_HELP = DATASRV_BASE_URL + 'gmt_help'
